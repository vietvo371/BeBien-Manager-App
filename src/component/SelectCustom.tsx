...
const SelectCustom: React.FC<SelectCustomProps> = ({
  ...
  const renderIcon = (iconUrl: string | number | undefined, size: number = 28, style?: any) => {
    if (!iconUrl) {
      return null; // Don't render anything if no icon URL
    }

    // Handle local assets (require() returns number)
      ...
      >
        ...
        >
          <View style={styles.optionContent}>
            {item.iconUrl && renderIcon(item.iconUrl, 32, styles.optionIcon)}
    ...
    <View style={[styles.container, containerStyle]}>
      ...
      >
        <View style={styles.buttonContent}>
          {selectedOption?.iconUrl && renderIcon(selectedOption.iconUrl, 24, styles.buttonIcon)}
